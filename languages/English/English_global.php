...
define(LAN_PLUGIN_ONTHISDAY_NAME, "On This Day ...");
...
define(LAN_PLUGIN_OTD_NAME, "On This Day Menu"); //
define(LAN_PLUGIN_OTD_DESC, "A menu and shortcode with a snippet of what happened on this day."); //
define(LAN_PLUGIN_OTD_LINK, "On This Day"); //
